...
import argparse
import pandas as pd
from src.data_extraction_real import load_real_historical_data, extract_statistical_parameters
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default="output_real",
        help="Directory to save generated datasets and reports (default: output_real)"
    )
    parser.add_argument(
        "--seed",
        type=int,
    ...
    # -------------------------------------------------------------------------
    print("\n[Step 1/4] Loading REAL historical EHR databases (HDHI & Nephrotoxic Drug)...")
    raw_cohort = load_real_historical_data(n_patients=args.n_patients, seed=args.seed)

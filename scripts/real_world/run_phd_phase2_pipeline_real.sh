#!/usr/bin/env bash
# run_phd_phase2_pipeline.sh — Phase 2 LLM Fine-Tuning Pipeline for PhD Proposal
#
# Usage:
...
EVAL_FILE="$PROJECT_DIR/data/real_world/phd_proposal_eval_holdout.jsonl"

# Output destinations
OUTPUT_DIR="$PROJECT_DIR/outputs/real_world/phd-gemma-12b"
MERGED_DIR="$PROJECT_DIR/exports/real_world/phd-gemma-12b-merged-bf16"
GGUF_F16="$PROJECT_DIR/exports/real_world/phd-gemma-12b-f16.gguf"
GGUF_Q6_K="$PROJECT_DIR/exports/real_world/phd-gemma-12b-q6_k.gguf"
EVAL_OUT="$PROJECT_DIR/reports/real_world/phd_eval_predictions.jsonl"
METRICS_FILE="$PROJECT_DIR/reports/real_world/phd_eval_predictions.metrics.json"
...
"$PYTHON_BIN" "$SCRIPT_DIR/../audit_labels.py" "$TRAIN_FILE" --json "$PROJECT_DIR/reports/real_world/phd_audit_summary.json"

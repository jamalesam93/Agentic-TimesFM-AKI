...
# Input datasets
TRAIN_FILE="$PROJECT_DIR/data/phd_proposal_sft_dataset.jsonl"
EVAL_FILE="$PROJECT_DIR/data/phd_proposal_eval_holdout.jsonl"

# Output destinations
OUTPUT_DIR="$PROJECT_DIR/outputs/phd-gemma-12b"
MERGED_DIR="$PROJECT_DIR/exports/phd-gemma-12b-merged-bf16"
GGUF_F16="$PROJECT_DIR/exports/phd-gemma-12b-f16.gguf"
GGUF_Q6_K="$PROJECT_DIR/exports/phd-gemma-12b-q6_k.gguf"
EVAL_OUT="$PROJECT_DIR/reports/phd_eval_predictions.jsonl"
METRICS_FILE="$PROJECT_DIR/reports/phd_eval_predictions.metrics.json"
